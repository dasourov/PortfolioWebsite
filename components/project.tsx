...
export default function Project({
  ...
  return (
    <motion.a
      ...
      target="_blank"
    >
      <section className="bg-gray-100 max-w-[65rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-20 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
